...
external_css = [
    ...
    'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', # added by sumanta
]
...
def create_footer_new():
    p2 = html.P(
        children=[
            html.Span('Real-time data from '),
            html.A('USGS GeoJSON feed',
                   href='https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php', target='_blank'),
            html.Span('.'),
        ],
    )
    ...
    footer_new = html.Footer(div, style=footer_style)
    return footer_new
