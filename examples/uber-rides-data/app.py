...
<html>
    <head>
        ...
        {%metas%}
        <title>HalcyonAgri Digitization Dashboard | Uber Data App</title>
        {%favicon%}
        {%css%}
    </head>
    <body>
...
app.layout = html.Div([
    html.Div([
        html.Div([
            ...
            html.Div([
                html.Div([
                    html.H2("Uber Rides Pattern and Data App", style={'font-family': 'Dosis'}),
        ...
        dcc.Markdown("Open-source data from: [FiveThirtyEight](https://github.com/fivethirtyeight/uber-tlc-foil-response/tree/master/uber-trip-data)",
                     className="source"),
        dcc.Checklist(
            id="mapControls",
            options=[
