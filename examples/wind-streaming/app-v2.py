...
<html>
    <head>
        ...
        {%metas%}
        <title>HalcyonAgri Digitization Dashboard | Wind Speed Streaming</title>
        {%favicon%}
        {%css%}
    </head>
    <body>
...
app.layout = html.Div([
    html.Div([
        html.H2("Real-time Wind Speed Streaming"),
        # html.Img(src="https://s3-us-west-1.amazonaws.com/plotly-tutorials/logo/new-branding/dash-logo-by-plotly-stripe-inverted.png"),
        html.Img(src='https://www.halcyonagri.com/wp-content/themes/vw-lawyer-attorney/images/halcyon-logo.png', height='60%'),
    ], className='banner'),
    html.Div([
        html.H5("HalcyonAgri Rubber Plantation at Jambi (Real-time IoT Sensor Simulation)"),
    ], className='row'),
    html.Div([
        html.Div([
